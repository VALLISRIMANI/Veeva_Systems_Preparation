...
select employee_id, salary from employees where employee_id = 182;
...
select d.department_id, d.department_name, l.city, l.state_province from departments d
join locations l
on l.location_id = d.location_id;
...
select distinct department_id from employees where last_name = 'Taylor';

select e.first_name, e.last_name, e.department_id from employees e where e.department_id IN (select distinct department_id from employees where last_name = 'Taylor');
...
select j.job_title, d.department_name, concat(e.first_name, " ", e.last_name) as full_name, jh.start_date, jh.end_date from employees e
join departments d 
on d.department_id = e.department_id
join jobs j
...
select j.job_title, concat(e.first_name, " ", e.last_name) as full_name, j.max_salary - e.salary as difference from employees e
join jobs j
on e.job_id = j.job_id;
...
select d.department_name, avg(e.salary) as average_salary, count(*) as employees_count from employees e
join departments d 
on e.department_id = d.department_id
...
select concat(e.first_name, ' ', e.last_name) as full_name, j.job_title, j.max_salary - e.salary from employees e
join jobs j
on j.job_id = e.job_id
where e.department_id = 80;

/* 17. Write a query in SQL to display the name of the country, city, and the departments which are running there. */
select l.country_id, l.city, d.department_name from departments d
join locations l
on d.location_id = l.location_id;

/* 18. Write a query in SQL to display department name and the full name (first and last name) of the manager. */
select d.department_name, concat(m.first_name, ' ', m.last_name) as manager_name from departments d
join employees m
...
select e.salary, j.job_id, j.job_title, j.min_salary, j.max_salary from jobs j
join employees e
on j.job_id = e.job_id
...
select c.country_name, l.city, count(distinct d.department_id) as departments_count from departments d
join locations l
on l.location_id = d.location_id
join countries c
...
select d.department_name, concat(m.first_name, ' ', m.last_name) as manager_name, l.city from departments d 
join employees m
on d.manager_id = m.employee_id
join locations l
on d.location_id = l.location_id;
...
select concat(e.first_name, ' ', e.last_name) as full_name, j.job_title, jh.start_date, jh.end_date from employees e
join jobs j
on e.job_id = j.job_id
join job_history jh
on e.employee_id = jh.employee_id
...
select d.department_name, count(e.employee_id) as employees_count from departments d
left join employees e
on d.department_id = e.department_id
group by d.department_name;
...
select concat(e.first_name, ' ', e.last_name) as full_name, e.employee_id, c.country_name from employees e
join departments d
on e.department_id = d.department_id
join locations l
on d.location_id = l.location_id
